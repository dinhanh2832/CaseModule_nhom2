                        ...
                        <div class="col-3" id="cardproduct">
                            <div class="card mb-4">
                                <figure class="snip1361" style="width: 242px">
                                    <img src="img/logo.jpg" alt="sample45" style="width: 246px"/>
                                    <figcaption>
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <a href="/products?action=deleteCart&id=${carts.get(i).idProduct}&idC=${idC}"
                                       onclick="if (confirm('Delete selected item?')){return true;}else{event.stopPropagation(); event.preventDefault();}"
                                       title="Link Title" class="btn btn-outline-secondary">
                                        Hủy
                                    </a>
                                </div>
                            </div>
