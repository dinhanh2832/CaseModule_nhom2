...
<div class="container-fluid mt-2">
    <div class="row">
        <div class="col-3"></div>
        <div class="col-6">
            <img src="img/item1.jpg" alt="..." class="img-fluid mt-3">
            <img src="img/item2.jpg" alt="..." class="img-fluid mt-3">
            <img src="img/item3.jpg" alt="..." class="img-fluid mt-3">
            <img src="img/item4.jpg" alt="..." class="img-fluid mt-3">
            <img src="img/item5.jpg" alt="..." class="img-fluid mt-3">
            <img src="img/item6.jpg" alt="..." class="img-fluid mt-3">
            <img src="img/item7.jpg" alt="..." class="img-fluid mt-3">
            <img src="img/ittem8.jpg" alt="..." class="img-fluid mt-3">
        </div>
        <div class="col-3"></div>
    </div>
</div>
    ...
    <div class="container-fluid padding">
        <div class="row text-center">
            ...
            <div class="col-md-4">
                ...
                <img  style="margin-top: 10px;border-radius: 50%" src="img/dungkk.jpg" class="img-fluid">
                <img  style="margin-top: 10px;border-radius: 50%" src="img/anhkk.jpg" class="img-fluid">
                <img  style="margin-top: 10px;border-radius: 50%" src="img/binhkk.jpg" class="img-fluid"> <br>
                Ánh - Dũng - Bình
