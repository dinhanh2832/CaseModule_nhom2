    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsiver">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="#"><b class="bx"></b></a>
                </li>
...
<div class="container-fluid mt-3">
    <div class="row">
        ...
        <div class="col-10">
            <div class="row">
                <div class="col-6" id="cardProduct1">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            <h4 class="card-title"></h4>
                            <img src="img/logo.jpg" class="img-fluid">
                            <a href="/products"
                               class="btn btn-outline-secondary">Xem danh sách Nick</a>
                        </div>

                    </div>
                </div>
                <div class="col-6" id="cardProduct">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            <h4 class="card-title"></h4>
                            <img src="img/logo.jpg" class="img-fluid">
                            <a href="/customers"
                               class="btn btn-outline-secondary">Xem danh sách Người dùng</a>
                        </div>
